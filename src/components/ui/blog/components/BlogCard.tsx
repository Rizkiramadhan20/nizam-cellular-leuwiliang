...
export default function BlogCard({ blog }: BlogCardProps) {
    return (
        <div className='block bg-zinc-900/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-zinc-800/50 hover:border-zinc-700/50 transition-all duration-300 hover:shadow-lg'>
            <Link href={`/articles/${FormatSlug(blog.category)}/${FormatSlug(blog.slug)}`} className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300">
