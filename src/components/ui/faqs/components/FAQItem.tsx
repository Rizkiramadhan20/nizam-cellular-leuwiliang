        ...
        >
            <div className={`flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8 ${isEvenId ? 'md:flex-row-reverse' : ''}`}>
                <motion.div
                    ...
                    className="md:w-1/2"
                >
                    <h2 className='text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6 text-gray-800'>{faq.title}</h2>
                    ...
                    {faq.faqs.map((item, faqIndex) => (
                        ...
                        >
                            ...
                            <div className="collapse-title text-base sm:text-lg font-semibold text-gray-800 hover:text-gray-900 flex items-center">
                                <span className="mr-2 sm:mr-3 w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-primary-100 text-primary-600 flex items-center justify-center text-xs sm:text-sm font-bold">
                                    {faqIndex + 1}
                                </span>
                                {item.title}
                            </div>
