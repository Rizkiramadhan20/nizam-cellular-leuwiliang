...
export default function ProductGenreNotFound({ typeCategory, genreTitle }: { typeCategory: string, genreTitle: string }) {
    return (
            ...
            <div className="container mx-auto px-4 lg:px-8 xl:px-10 py-2 lg:py-12 max-w-7xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        ...
                        >
                            Kami tidak dapat menemukan project apa pun dalam kategori <span className="font-semibold text-blue-600">&quot;{typeCategory}&quot;</span> dengan genre <span className="font-semibold text-blue-600">&quot;{genreTitle}&quot;</span>. Project tersebut mungkin telah dipindahkan atau dihapus.
                        </motion.p>
                        <motion.div
                            className="pt-4"
                            initial={{ opacity: 0, y: 20 }}
