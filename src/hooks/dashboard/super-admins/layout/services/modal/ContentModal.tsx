...
import { ContentModalProps } from '@/hooks/dashboard/super-admins/layout/services/types/Services';
                  ...
                  <div className="bg-gray-50/50 p-6 rounded-2xl space-y-6 border border-[var(--border-color)]">
                    <div className="space-y-5">
                      ...
                      <div className="form-control">
                        <label className="block text-sm font-medium text-gray-700 mb-1.5">Text</label>
                        <textarea
                          className="w-full px-4 py-2.5 rounded-xl border border-[var(--border-color)] focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 min-h-[120px] transition-all duration-200 bg-transparent resize-none"
