...
const ContentModal = dynamic(() => import('@/hooks/dashboard/super-admins/layout/home/modal/ContentModal').then(mod => mod.ContentModal), {
  ssr: false
})

const DeleteModal = dynamic(() => import('@/hooks/dashboard/super-admins/layout/home/modal/DeleteModal').then(mod => mod.DeleteModal), {
  ssr: false
})

const HomeSkelaton = dynamic(() => import('@/hooks/dashboard/super-admins/layout/home/HomeLayout').then(mod => mod.default), {
  ssr: false
})
...
export default function HomeLayout() {
  ...
  useEffect(() => {
    if (currentContent?.typing?.length) {
      const timer = setInterval(() => {
        setCurrentIndex((prev) =>
          prev === currentContent.typing.length - 1 ? 0 : prev + 1
        );
              ...
              >
                <div className="space-y-8 max-w-xl">
                      ...
                      <AnimatePresence mode="wait">
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {currentContent?.typing[currentIndex]?.title}
                            </motion.h1>
                            <motion.span
                  ...
                  <div className="flex flex-wrap gap-4">
                    <a
                      href={currentContent.button1.href}
                      className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-blue-500 hover:from-indigo-700 hover:to-blue-600 text-white rounded-xl transition-all duration-300 text-center min-w-[160px] shadow-sm hover:shadow-lg hover:shadow-indigo-100"
                    >
                      {currentContent.button1.text}
                    </a>
                    <a
                      href={currentContent.button2.href}
                      className="px-6 py-3 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-all duration-300 text-center min-w-[160px] border border-gray-200"
                    >
                      {currentContent.button2.text}
                    </a>
                  </div>
