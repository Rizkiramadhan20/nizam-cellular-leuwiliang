    ...
    >
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8 bg-background border border-[var(--border-color)] p-6 sm:p-8 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300"
        >
