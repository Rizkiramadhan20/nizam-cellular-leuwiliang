...
import { ContentModalProps } from '@/hooks/dashboard/super-admins/product/genre/types/ProductGenre';
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full p-6 md:p-8 max-h-[90vh] overflow-y-auto custom-scrollbar">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500">Fill in the information below to {isEditing ? 'update' : 'create'} your genre</p>
              </div>
              <button
                onClick={onClose}
            ...
            <form method="dialog" onSubmit={(e) => {
              ...
              <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
                ...
                <button
                  ...
                  disabled={isSubmitting || !formData.categoryTitle || !formData.title}
                >
                  {isSubmitting ? (
                    <>
