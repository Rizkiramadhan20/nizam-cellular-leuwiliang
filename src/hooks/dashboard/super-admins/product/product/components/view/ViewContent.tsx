        ...
        <>
            {hasContent && (
                <div className="bg-white rounded-2xl border border-gray-100 p-6">
                    ...
                    {hasDescription && <p>{project.description}</p>}
                    ...
                    <div className="prose prose-lg max-w-none 
                        ...
                        prose-li[data-list=bullet]:before:content-['•'] prose-li[data-list=bullet]:before:absolute prose-li[data-list=bullet]:before:left-0 prose-li[data-list=bullet]:before:text-gray-500 prose-li[data-list=bullet]:before:font-bold
                        prose-li[data-list=ordered]:before:absolute prose-li[data-list=ordered]:before:left-0 prose-li[data-list=ordered]:before:text-gray-700 prose-li[data-list=ordered]:before:font-semibold prose-li[data-list=ordered]:before:counter-reset prose-li[data-list=ordered]:before:content-[counter(list-item)'.']
