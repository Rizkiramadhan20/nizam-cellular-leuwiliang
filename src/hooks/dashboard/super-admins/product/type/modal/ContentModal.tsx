...
import { ContentModalProps } from '@/hooks/dashboard/super-admins/product/type/types/ProductType';

import { ProductType } from '@/hooks/dashboard/super-admins/product/type/lib/FetchProductType';

interface ExtendedContentModalProps extends ContentModalProps {
  types: ProductType[];
}

export const ContentModal: React.FC<ExtendedContentModalProps> = ({
  isEditing,
  formData,
  setFormData,
  handleSubmit,
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full p-6 md:p-8 max-h-[90vh] overflow-y-auto custom-scrollbar">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500">Fill in the information below to {isEditing ? 'update' : 'create'} your type</p>
              </div>
              <button
                onClick={onClose}
            ...
            <form method="dialog" onSubmit={(e) => {
                  ...
                  <div className="space-y-5">
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          setFormData({
                            ...
                            genreTitle: "" // Reset type when category changes
                          });
                        }}
                      >
                        <option value="">Select a category</option>
                        {[...new Set(types.map(type => type.categoryTitle))]
                    ...
                    <div className="form-control">
                      ...
                      <select
                        ...
                        onChange={(e) => setFormData({ ...formData, genreTitle: e.target.value })}
                      >
                        <option value="">Select a type</option>
                        {[...new Set(types
                          .filter(type => type.categoryTitle === formData.categoryTitle)
                          .map(type => type.title))]
                          .map((title) => (
              ...
              <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
                ...
                <button
                  ...
                  disabled={isSubmitting || !formData.genreTitle || !formData.title || !formData.categoryTitle}
                >
                  {isSubmitting ? (
                    <>
