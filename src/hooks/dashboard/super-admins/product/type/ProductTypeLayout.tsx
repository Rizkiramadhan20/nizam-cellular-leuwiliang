...
import { useProductTypeData } from '@/hooks/dashboard/super-admins/product/type/lib/FetchProductType';

import { ContentModal } from '@/hooks/dashboard/super-admins/product/type/modal/ContentModal';

import { DeleteModal } from '@/hooks/dashboard/super-admins/product/type/modal/DeleteModal';

import FeaturedSkelaton from '@/hooks/dashboard/super-admins/product/type/ProductTypeSkelaton';

import { ProductTypeFormData, initialFormData } from '@/hooks/dashboard/super-admins/product/type/types/ProductType';

import { containerVariants, itemVariants } from '@/hooks/dashboard/super-admins/product/type/animation/animation';
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div className="space-y-1">
                        ...
                        <p className='text-gray-500'>
                            Manage and organize your product type
                        </p>
                    </div>
                    ...
                    <div className="flex-1">
                        <div className="relative">
                            ...
                            <div className="relative">
                                <select
                                    id="genreFilter"
                                    value={selectedGenreTitle}
                                    onChange={(e) => setSelectedGenreTitle(e.target.value)}
                                    className="block w-full px-4 py-3 text-gray-700 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 appearance-none transition-all duration-200"
                                >
                        ...
                        <div className="relative">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    onChange={(e) => setSelectedTypeTitle(e.target.value)}
                                    className="block w-full px-4 py-3 text-gray-700 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 appearance-none transition-all duration-200"
                                >
