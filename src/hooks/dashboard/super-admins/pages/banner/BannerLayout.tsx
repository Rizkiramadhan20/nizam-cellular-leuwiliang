...
import { useBannerData } from '@/hooks/dashboard/super-admins/pages/banner/lib/FetchIcons'

const ContentModal = dynamic(() => import('@/hooks/dashboard/super-admins/pages/banner/modal/ContentModal').then(mod => mod.ContentModal), {
    ssr: false
})

const DeleteModal = dynamic(() => import('@/hooks/dashboard/super-admins/pages/banner/modal/DeleteModal').then(mod => mod.DeleteModal), {
    ssr: false
})

const KonsultasiSkelaton = dynamic(() => import('@/hooks/dashboard/super-admins/pages/banner/BannerSkelaton').then(mod => mod.default), {
    ssr: false
})

const initialFormData: BannerContent = {
    imageUrl: ''
};
...
export default function BannerLayout() {
    ...
    const [formData, setFormData] = useState<BannerContent>(initialFormData)
        ...
        >
            ...
            >
                <div className="space-y-2">
                    ...
                    <p className='text-gray-600 text-sm sm:text-base'>Manage your banner page</p>
                </div>
