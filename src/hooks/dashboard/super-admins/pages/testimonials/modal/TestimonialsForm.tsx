...
import { Testimonial } from '@/hooks/dashboard/super-admins/pages/testimonials/types/Testimonials';
...
export default function TestimonialForm({ testimonial, onSubmit, onClose }: Props) {
  ...
  return (
    <dialog ref={modalRef} className="modal">
      <div className="modal-box bg-white max-w-6xl p-0 overflow-hidden flex flex-col h-[90vh]">
        {/* Modal Header */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="form-control">
                    <label className="text-sm font-medium text-gray-700 mb-1.5">Rating</label>
                    <div className="flex items-center gap-2">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <button
                          ...
                          className={`p-1 rounded-full transition-all ${formData.rating >= star ? 'text-yellow-400' : 'text-gray-300'
                            }`}
                        >
                  ...
                  <div className="form-control flex-1">
                    ...
                    <textarea
                      name="message"
                      className="textarea textarea-bordered w-full bg-white border-gray-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all rounded-lg h-full min-h-[120px]"
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="form-control h-full">
                  {(imageFile || testimonial?.imageUrl) ? (
                    ...
                    <div className="relative border-2 border-dashed border-gray-200 rounded-lg hover:border-green-500 transition-all h-full">
                      <input
                        id="image-input"
                        type="file"
                        accept="image/*"
