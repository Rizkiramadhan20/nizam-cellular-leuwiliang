...
import { testimonialService } from '@/hooks/dashboard/super-admins/pages/testimonials/lib/FetchTestimonials';

import TestimonialForm from '@/hooks/dashboard/super-admins/pages/testimonials/modal/TestimonialsForm';

import TestimonialCard from '@/hooks/dashboard/super-admins/pages/testimonials/components/TestimonialsCard';

import TestimonialSkelaton from '@/hooks/dashboard/super-admins/pages/testimonials/TestimonialsSkelaton';
      ...
      <div className="bg-background rounded-2xl shadow-sm border border-[var(--border-color)] p-6 mb-8">
        ...
        <div className="mt-6">
          <input
            ...
            className="w-full px-4 py-2 border border-[var(--border-color)] bg-transparent rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
          />
        </div>
      </div>
