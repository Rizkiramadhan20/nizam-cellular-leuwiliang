...
import { BrandVoucherContentFormData, initialFormData } from '@/hooks/dashboard/super-admins/voucher/voucher/brand/types/BrandVoucher';
...
export default function ProductCategoryLayout() {
    ...
    const [formData, setFormData] = useState<BrandVoucherContentFormData>(initialFormData);
