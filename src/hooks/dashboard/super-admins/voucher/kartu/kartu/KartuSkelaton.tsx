...
export default function VoucherSkelaton() {
    return (
        <section>
            {/* Header Skeleton */}
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-4 text-right text-xs font-semibold text-gray-600 uppercase tracking-wider whitespace-nowrap">
                                    <div className="h-4 w-24 bg-gray-200 rounded relative overflow-hidden ml-auto">
                                        <div className="absolute inset-0 -translate-x-full animate-[shimmer_1.5s_infinite] bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200"></div>
                                    </div>
                                </th>
                            </tr>
