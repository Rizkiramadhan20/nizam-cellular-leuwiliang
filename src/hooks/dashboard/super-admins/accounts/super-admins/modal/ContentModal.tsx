            ...
            <div className="bg-white rounded-3xl shadow-xl max-w-md w-full p-4 md:p-8 max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-4">
                    <div className="form-control">
                        ...
                        <input
                            type="text"
                            className="w-full px-4 py-2 rounded-lg border border-[var(--border-color)] focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    ...
                    <div className="form-control">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-2 rounded-lg border border-[var(--border-color)] focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 pr-10"
