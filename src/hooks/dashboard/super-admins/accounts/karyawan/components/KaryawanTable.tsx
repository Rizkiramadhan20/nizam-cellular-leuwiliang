import { UserTableProps } from '@/hooks/dashboard/super-admins/accounts/karyawan/types/Karyawan';
...
export default function UserTable({ users, onEdit, onDelete, deletingId }: UserTableProps) {
    return (
        <div className="bg-white rounded-3xl shadow-sm border border-[var(--border-color)] overflow-hidden">
