...
import { ContentModalProps } from '@/hooks/dashboard/super-admins/handphone/owner/types/Owner';
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="space-y-1">
                <h3 className="text-2xl font-bold text-gray-900">
                  {isEditing ? 'Edit Pemilik Handphone' : 'Create New Pemilik Handphone'}
                </h3>
                <p className="text-sm text-gray-500">Isi informasi di bawah ini untuk {isEditing ? 'update' : 'create'} pemilik handphone</p>
              </div>
              <button
                onClick={onClose}
