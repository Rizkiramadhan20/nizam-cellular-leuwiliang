    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="bg-white rounded-3xl border border-[var(--border-color)] backdrop-blur-xl p-8"
            >
                                ...
                                {[
                                    ...
                                    <motion.div
                                        ...
                                        className="group p-6 bg-gray-50/50 rounded-2xl hover:bg-white transition duration-300 
                                            hover:shadow-lg hover:shadow-gray-100/50 border border-[var(--border-color)]"
                                    >
                                    ...
                                    >
                                        <button
                                            ...
                                            className="px-8 py-3 bg-white text-gray-700 rounded-xl hover:bg-gray-50 
                                                transition-all duration-300 font-medium border-2 border-[var(--border-color)] 
