  ...
  return (
    <Fragment>
      <div className="flex h-screen bg-[var(--background)] overflow-hidden">
        ...
        `}>
          {/* Top Navigation Bar */}
          <header className="sticky top-0 z-20 h-16 bg-[var(--header-bg)] border-b border-[var(--header-border)] flex items-center justify-between px-4 lg:px-6 backdrop-blur-sm shadow-[var(--header-shadow)]">
            {/* Left side */}
